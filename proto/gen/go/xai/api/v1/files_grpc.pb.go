...
const (
	...
	Files_GetFile_FullMethodName         = "/xai_api.Files/GetFile"
	Files_DeleteFile_FullMethodName      = "/xai_api.Files/DeleteFile"
	Files_GetFileContent_FullMethodName  = "/xai_api.Files/GetFileContent"
...
type FilesClient interface {
	...
	GetFileContent(ctx context.Context, in *GetFileContentRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileContentChunk], error)
...
func (c *filesClient) GetFileContent(ctx context.Context, in *GetFileContentRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileContentChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Files_ServiceDesc.Streams[1], Files_GetFileContent_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetFileContentRequest, FileContentChunk]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Files_GetFileContentClient = grpc.ServerStreamingClient[FileContentChunk]
...
type FilesServer interface {
	...
	GetFileContent(*GetFileContentRequest, grpc.ServerStreamingServer[FileContentChunk]) error
...
func (UnimplementedFilesServer) GetFileContent(*GetFileContentRequest, grpc.ServerStreamingServer[FileContentChunk]) error {
...
func (UnimplementedFilesServer) RetrieveFileURL(context.Context, *RetrieveFileURLRequest) (*RetrieveFileURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RetrieveFileURL not implemented")
}
func (UnimplementedFilesServer) CreatePublicUrl(context.Context, *CreatePublicUrlRequest) (*CreatePublicUrlResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreatePublicUrl not implemented")
}
...
func _Files_GetFileContent_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetFileContentRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(FilesServer).GetFileContent(m, &grpc.GenericServerStream[GetFileContentRequest, FileContentChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Files_GetFileContentServer = grpc.ServerStreamingServer[FileContentChunk]
...
var Files_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _Files_GetFileContent_Handler,
			ServerStreams: true,
		},
	},
