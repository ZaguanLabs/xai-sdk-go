...
const (
	Files_UploadFile_FullMethodName   = "/xai.v1.Files/UploadFile"
	Files_DownloadFile_FullMethodName = "/xai.v1.Files/DownloadFile"
	Files_ListFiles_FullMethodName    = "/xai.v1.Files/ListFiles"
	Files_GetFile_FullMethodName      = "/xai.v1.Files/GetFile"
	Files_DeleteFile_FullMethodName   = "/xai.v1.Files/DeleteFile"
)
...
func (c *filesClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Files_ServiceDesc.Streams[1], Files_DownloadFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Files_DownloadFileClient = grpc.ServerStreamingClient[FileChunk]
...
func (UnimplementedFilesServer) DownloadFile(*DownloadFileRequest, grpc.ServerStreamingServer[FileChunk]) error {
...
func _Files_DownloadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FilesServer).DownloadFile(m, &grpc.GenericServerStream[DownloadFileRequest, FileChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Files_DownloadFileServer = grpc.ServerStreamingServer[FileChunk]
