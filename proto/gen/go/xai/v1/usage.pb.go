...
// ServerSideTool represents server-side tools that can be used during completion.
...
func (ServerSideTool) Descriptor() protoreflect.EnumDescriptor {
	return file_xai_v1_usage_proto_enumTypes[0].Descriptor()
}

func (ServerSideTool) Type() protoreflect.EnumType {
	return &file_xai_v1_usage_proto_enumTypes[0]
}
...
func (ServerSideTool) EnumDescriptor() ([]byte, []int) {
	return file_xai_v1_usage_proto_rawDescGZIP(), []int{0}
}
...
func (x *EmbeddingUsage) Reset() {
	*x = EmbeddingUsage{}
	mi := &file_xai_v1_usage_proto_msgTypes[0]
...
// SamplingUsage tracks token usage for sampling/completion operations.
...
func (x *SamplingUsage) Reset() {
	*x = SamplingUsage{}
	mi := &file_xai_v1_usage_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SamplingUsage) Descriptor() ([]byte, []int) {
	return file_xai_v1_usage_proto_rawDescGZIP(), []int{1}
}
...
var File_xai_v1_usage_proto protoreflect.FileDescriptor

const file_xai_v1_usage_proto_rawDesc = "" +
	"\n" +
	"\x12xai/v1/usage.proto\x12\axai_api\x1a\x1fgoogle/protobuf/timestamp.proto\"r\n" +
	"\x0eEmbeddingUsage\x12.\n" +
	"\x13num_text_embeddings\x18\x01 \x01(\x05R\x11numTextEmbeddings\x120\n" +
	"\x14num_image_embeddings\x18\x02 \x01(\x05R\x12numImageEmbeddings\"\xc0\x03\n" +
	"\rSamplingUsage\x12+\n" +
	...
	"\x16server_side_tools_used\x18\t \x03(\x0e2\x17.xai_api.ServerSideToolR\x13serverSideToolsUsed*\x9a\x02\n" +
	...
	"\x14SERVER_SIDE_TOOL_MCP\x10\aB<Z:github.com/ZaguanLabs/xai-sdk-go/proto/gen/go/xai/v1;xaiv1b\x06proto3"

var (
	file_xai_v1_usage_proto_rawDescOnce sync.Once
	file_xai_v1_usage_proto_rawDescData []byte
)

func file_xai_v1_usage_proto_rawDescGZIP() []byte {
	file_xai_v1_usage_proto_rawDescOnce.Do(func() {
		file_xai_v1_usage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_xai_v1_usage_proto_rawDesc), len(file_xai_v1_usage_proto_rawDesc)))
	})
	return file_xai_v1_usage_proto_rawDescData
}

var file_xai_v1_usage_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_xai_v1_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_xai_v1_usage_proto_goTypes = []any{
...
var file_xai_v1_usage_proto_depIdxs = []int32{
...
func init() { file_xai_v1_usage_proto_init() }
func file_xai_v1_usage_proto_init() {
	if File_xai_v1_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_xai_v1_usage_proto_rawDesc), len(file_xai_v1_usage_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_xai_v1_usage_proto_goTypes,
		DependencyIndexes: file_xai_v1_usage_proto_depIdxs,
		EnumInfos:         file_xai_v1_usage_proto_enumTypes,
		MessageInfos:      file_xai_v1_usage_proto_msgTypes,
	}.Build()
	File_xai_v1_usage_proto = out.File
	file_xai_v1_usage_proto_goTypes = nil
	file_xai_v1_usage_proto_depIdxs = nil
}
